...
* django tables 2: https://enzircle.com/responsive-table-with-django-and-htmx

# django project examples
- compendium: https://github.com/wsvincent/awesome-django
- sentry: https://github.com/getsentry/sentry (bootstrap, agents)
...
sudo su postgres
psql
DROP DATABASE eco_blog;  // clear current db
create database eco_blog with owner jan;  // create new db

## update diagram of database
